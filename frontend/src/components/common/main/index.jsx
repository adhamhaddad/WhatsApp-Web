...
const Main = () => {
  ...
  return (
    <div className={`${styles['main']} ${styles[theme.palette.type]}`}>
      <ChatProvider>
        <div className={styles['left-side']}>
          <Routes handleCurrentChat={handleCurrentChat} socket={socket} />
        </div>
        <div className={styles['right-side']}>
          <Switch>
            {currentChat && (
              <Route
                path='/'
                render={() => <Chat {...currentChat} socket={socket} />}
              />
            )}
            {!currentChat && (
              <div className={styles['whats-app-page']}>
                <span className={styles['whats-app-logo']}>
                  <svg viewBox='0 0 303 172' width='360' fill='none'>
                    <path
                      ...
                      fill={theme.palette.main.rightSide.logo.background}
                    ></path>
                    <path
                      fillRule='evenodd'
                      clipRule='evenodd'
                    ...
                    <path
                      ...
                      fill={theme.palette.main.rightSide.logo.imgColor}
                      stroke='#316474'
                    ></path>
                    <path
                ...
                <h2 style={{ color: theme.palette.main.rightSide.color }}>
                  WhatsApp Web
                </h2>
                <p className={styles['whats-app-paragraph']}>
                ...
                <div className={styles['message-type']}>
                  <span>
                    <svg viewBox='0 0 10 12' height='12' width='10'>
                      <path
