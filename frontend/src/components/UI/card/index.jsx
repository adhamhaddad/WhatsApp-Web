  ...
  return (
    <li>
      <NavLink
        ...
        exact
        to='/'
        className={`${styles['card']} ${styles[theme.palette.type]}`}
      ...
      >
        ...
        <div className={styles['card-info']}>
          <div className={styles['top-side']}>
            <h3 className={styles['name']} color='primary'>
              {first_name && `${first_name} ${last_message}`}
              {!first_name && name}
            </h3>
          ...
          <div className={styles['bottom-side']}>
            ...
            {/* <span className={styles['count']}>{unread_count}</span> */}
          </div>
        </div>
      </NavLink>
    </li>
